    ...
    return (
      <div className="max-w-2xl mx-auto px-4 py-16 animate-fade-in">
        <div className="card p-10 text-center">
          <Globe size={44} className="text-brand-400/60 mx-auto mb-5" />
          <h2 className="text-xl font-bold text-white mb-2">
            {user?.isGoogleConnected ? 'No websites linked yet' : 'Get started'}
          </h2>

          {user?.isGoogleConnected ? (
            <>
              <p className="text-slate-400 text-sm mb-6 leading-relaxed">
                Your Google account is connected. Click <strong className="text-white">Discover Properties</strong> to
                automatically find your Google Analytics and Search Console properties,
                or go to Settings to link them manually.
              </p>
              <div className="flex items-center justify-center gap-3 flex-wrap">
                ...
                >
                  {discovering
                    ? <><span className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" /> Discovering…</>
                    : '🔍 Discover Properties'}
                </button>
            ...
            <>
              <p className="text-slate-400 text-sm mb-6 leading-relaxed">
                Connect your Google account to automatically import your Analytics and
                Search Console data into the dashboard.
              </p>
              <Link
